...
class PublishersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publisher" do
    assert_difference("Publisher.count") do
      post publishers_url, params: { publisher: { address: @publisher.address, name: @publisher.name, phone: @publisher.phone } }
    end
  ...
  test "should update publisher" do
    patch publisher_url(@publisher), params: { publisher: { address: @publisher.address, name: @publisher.name, phone: @publisher.phone } }
